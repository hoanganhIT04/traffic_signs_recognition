...
DATASET_PATH = r"A:\Thực tập chuyên môn I\traffic-signs-recognition\data"
OUTPUT_PATH = r"A:\Thực tập chuyên môn I\traffic-signs-recognition\data_resized"
TARGET_SIZE = (224, 224)
...
if error_files:
    print(f"⚠️ Có {len(error_files)} ảnh lỗi:")
